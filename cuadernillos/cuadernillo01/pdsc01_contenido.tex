...
\begin{ejercicio}{Ejercicio 1. Completar las ideas centrales}
...
\begin{tabular}{|c|c|c|}
\hline
software de sistemas & programación de sistemas & aplicación \tabularnewline
\hline
arquitectura de la computadora & niveles de abstracción & interfaces \tabularnewline
\hline
\end{tabular}
\end{center}
...
\ifrespuestas\else\newpage\fi
\begin{ejercicio}{Ejercicio 2. Aplicación o software de sistemas}
...
\begin{ejercicio}{Ejercicio 3. Relacionar responsabilidades}
...
\ifrespuestas\else\newpage\fi
\begin{ejercicio}{Ejercicio 4. Del código fuente a la memoria}
...
\hline
compilador & ensamblador & ligador & cargador \tabularnewline
\hline
código en lenguaje ensamblador & código objeto & ejecutable & memoria \tabularnewline
\hline
\end{tabular}
\end{center}
...
\begin{ejercicio}{Ejercicio 5. Comparar dos procesadores de lenguajes}
...
\begin{tabular}{|c|c|c|}
\hline
programa fuente & programa fuente y datos & traduce \tabularnewline
\hline
ejecuta operaciones & programa destino & resultados de la ejecución \tabularnewline
\hline
\end{tabular}
\end{center}
...
\begin{ejercicio}{Ejercicio 6. Identificar el modelo}
...
\begin{ejercicio}{Ejercicio 7. Cuatro ideas para construir una herramienta}
...
\begin{ejercicio}{Ejercicio 8. El caso del compilador del curso}
El producto acumulativo del curso puede representarse así:

\begin{center}
\fbox{programa en \textsc{IMP}}
\(\longrightarrow\)
...
\begin{enumerate}[leftmargin=*]
    \item ¿Cuál es el lenguaje fuente? \blank[6cm]
    \item ¿Cuál es el lenguaje destino? \blank[6cm]
...
\begin{ejercicio}{Ejercicio 9. Detectar y corregir confusiones}
