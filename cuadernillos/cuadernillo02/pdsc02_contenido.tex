...
\begin{ejercicio}{Ejercicio 1. Reconocer los contratos entre fases}
...
\begin{tabular}{|c|c|c|}
\hline
secuencia de tokens & representación estructurada & representación validada \tabularnewline
\hline
representación intermedia & representación intermedia equivalente & programa destino \tabularnewline
\hline
\end{tabular}
\end{center}
...
\ifrespuestas\else\newpage\fi
\begin{ejercicio}{Ejercicio 2. Análisis o síntesis}
...
\begin{ejercicio}{Ejercicio 3. ¿Qué fase debe responder?}
...
\begin{ejercicio}{Ejercicio 4. Delimitación de responsabilidades}
...
\begin{ejercicio}{Ejercicio 5. Completar el recorrido de \textsc{IMP} a \textsc{C}}
...
\hline
análisis léxico & análisis sintáctico & verificación semántica & generación de código \tabularnewline
\hline
\end{tabular}
\end{center}
...
\begin{ejercicio}{Ejercicio 6. Interfaces y cambios}
...
\begin{ejercicio}{Ejercicio 7. Token, lexema, patrón o atributo}
...
\begin{ejercicio}{Ejercicio 8. Analizar un fragmento ilustrativo}
...
\begin{tabular}{|c|c|c|c|}
\hline
\texttt{ID} & \texttt{ASIG} & \texttt{ENTERO} & \texttt{PYC} \tabularnewline
\hline
\(\langle\texttt{ID},\texttt{total}\rangle\) & \(\langle\texttt{ASIG}\rangle\) & \(\langle\texttt{ENTERO},25\rangle\) & \(\langle\texttt{PYC}\rangle\) \tabularnewline
\hline
\end{tabular}
\end{center}
...
\begin{ejercicio}{Ejercicio 9. Solicitar el siguiente token}
...
\hline
token & caracteres & lexema & nombre de token & atributo \tabularnewline
\hline
\end{tabular}
\end{center}
...
\ifrespuestas\else\newpage\fi
\begin{ejercicio}{Ejercicio 10. Detectar y corregir confusiones}
