...
\textbf{Lectura esencial:} sigue el caso inicial; localiza las definiciones y comparaciones de las secciones 1 y 3; reconoce las responsabilidades y el recorrido panorámico de la sección 2; y cierra con el esquema \textsc{IMP} \(\rightarrow\) \textsc{C} y las cuatro ideas de la sección 4.
