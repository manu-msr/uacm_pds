...
\textbf{Lectura complementaria:} revisa después los matices sobre espacios y comentarios, las dos formas de observar la comunicación con el analizador sintáctico y la configuración de \textsc{Lark}. Retoma esta última parte al comenzar la Práctica 1.
\end{ruta}
