...
\begin{itemize}
\item Ejercicio 1: reconocer los contratos entre fases.
\item Ejercicio 2: distinguir las tareas de análisis y de síntesis.
\end{itemize}
...
\begin{itemize}
\item Ejercicio 3: decidir qué fase debe responder en cada situación.
\item Ejercicio 4: revisar los límites de responsabilidad entre fases.
\end{itemize}
...
\resizebox{.96\textwidth}{!}{%
\begin{tikzpicture}[node distance=.42cm]
\node[mini, fill=pastelgreen, text width=2cm] (a) {programa\\\textsc{IMP}};
...
\begin{itemize}
\item Ejercicio 5: completar el recorrido de \textsc{IMP} a \textsc{C}.
\item Ejercicio 6: analizar las interfaces y el efecto de sus cambios.
\end{itemize}
...
\begin{itemize}
\item Ejercicio 7: relacionar token, lexema, patrón y atributo.
\item Ejercicio 8: analizar el fragmento ilustrativo \texttt{total = 25;}.
\end{itemize}
...
\begin{itemize}
\item Ejercicio 9: completar la comunicación para solicitar el siguiente token.
\item Ejercicio 10: detectar y corregir confusiones del repaso completo.
\end{itemize}
...
\begin{center}
\term{Comprender cada contrato permite construir y probar el compilador de manera acumulativa.}
\end{center}
