...
\begin{itemize}
\item Ejercicio 1: completar las ideas centrales.
\item Ejercicio 2: distinguir aplicaciones y software de sistemas.
\end{itemize}
...
\begin{itemize}
\item Ejercicio 3: relacionar herramientas y responsabilidades.
\item Ejercicio 4: completar el recorrido del código fuente a la memoria.
\end{itemize}
...
\begin{itemize}
\item Ejercicio 5: comparar compilador e intérprete.
\item Ejercicio 6: identificar el modelo descrito en cada situación.
\end{itemize}
...
\node[bloque, fill=pastelgreen, text width=2.65cm] (a) {programa en \textsc{IMP}};
...
\begin{block}{¿Por qué es un caso integrador?}
...
\begin{itemize}
\item Ejercicio 7: relacionar decisiones con las cuatro ideas.
\item Ejercicio 8: analizar el compilador de \textsc{IMP} a \textsc{C}.
\end{itemize}
...
\begin{itemize}
\item Detectar la parte incorrecta de cada afirmación.
